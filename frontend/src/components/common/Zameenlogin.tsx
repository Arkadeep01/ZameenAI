...
// import { Mail, Lock, Eye, EyeOff, HelpCircle, ChevronDown, Landmark, User, ShieldCheck } from "lucide-react";
...
//                     className="w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-3 text-sm text-slate-800 placeholder:text-slate-400 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-100"
//                   />
//                 </div>
//               </div>
...
//                     className="w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-10 text-sm text-slate-800 placeholder:text-slate-400 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-100"
//                   />
//                   <button
//                     type="button"
...
//               <button
//                 type="submit"
//                 className="flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-950 py-3 text-sm font-semibold text-white transition hover:bg-emerald-900"
//               >
//                 Sign In
...
//             <button
//               type="button"
//               className="flex w-full items-center gap-3 rounded-lg border border-slate-300 px-4 py-3 text-left transition hover:bg-slate-50"
//             >
//               <img
//                 src="https://upload.wikimedia.org/wikipedia/commons/5/55/Emblem_of_India.svg"
//                 alt=""
...
//                 <span className="block text-xs text-slate-500">Secure Access for Government Users</span>
//               </span>
//             </button>
...
//                 <button onClick={onSwitchToSignup} className="font-medium text-emerald-700 hover:text-emerald-800">
//                   Create Account
//                 </button>
//               </p>
//             )}
...
const DEMO_CREDENTIALS: Record<UserType, { email: string; password: string }> = {
  government: { email: "officer.demo@zameenai.gov.in", password: "Demo@123" },
  citizen: { email: "citizen.demo@zameenai.gov.in", password: "Demo@123" },
};
...
const LoginPage: React.FC<LoginPageProps> = ({ onSwitchToSignup, onLoginSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setSuccess(true);
      setTimeout(() => onLoginSuccess?.(userType), 700);
    }, 900);
  };
