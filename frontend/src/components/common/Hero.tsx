        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-tight">
              {isHi ? HERO_CONTENT.tagline.hi : HERO_CONTENT.tagline.en}
            </h1>

            {/* Mission Statement */}
            <p className="text-sm sm:text-base text-blue-100/80 leading-relaxed font-normal max-w-2xl">
              {isHi ? HERO_CONTENT.missionStatement.hi : HERO_CONTENT.missionStatement.en}
            </p>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
              ...
              >
                ...
                <div className="flex flex-col items-start leading-tight text-left">
                  <span>{isHi ? HERO_CONTENT.officialCta.hi : 'Official Login (PIAs/LAOs)'}</span>
                  <span className="text-[10px] font-normal text-orange-100">
                    {isHi ? HERO_CONTENT.officialCtaSub.hi : HERO_CONTENT.officialCtaSub.en}
                  </span>
                </div>
              ...
              >
                ...
                <div className="flex flex-col items-start leading-tight text-left">
                  <span>{isHi ? HERO_CONTENT.citizenCta.hi : HERO_CONTENT.citizenCta.en}</span>
                  <span className="text-[10px] font-normal text-blue-200">
                    {isHi ? HERO_CONTENT.citizenCtaSub.hi : HERO_CONTENT.citizenCtaSub.en}
                  </span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 flex-1 px-2.5 py-1 text-white text-xs">
                  ...
                  <input
                    ...
                    placeholder={isHi ? "खसरा / सर्वे संख्या या अधिसूचना आईडी दर्ज करें (उदा. 142/2)" : "Enter Khasra / Survey No. or Notification ID (e.g. 142/2)"}
                ...
                >
                  ...
                  <span>{isHi ? "ट्रैक करें" : "Track Parcel"}</span>
                </button>
              </form>
              <div className="flex items-center gap-2 mt-2 text-[11px] text-blue-200/80 flex-wrap">
                <span className="font-semibold text-blue-100">{isHi ? "त्वरित उदाहरण:" : "Quick Demo:"}</span>
                <button
                  type="button"
            ...
            <div className="pt-2 border-t border-white/15 flex flex-wrap items-center gap-4 text-xs text-blue-100/90">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-medium">{isHi ? 'एसटीक्यूसी (STQC) प्रमाणित' : 'STQC Certified Portal'}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Lock className="w-4 h-4 text-[#ff9933]" />
                <span className="font-medium">{isHi ? 'डीपीडीपी अधिनियम 2023 अनुपालन' : 'DPDP Act 2023 Protected'}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Building2 className="w-4 h-4 text-blue-200" />
                <span className="font-medium">{isHi ? 'भूमि अधिग्रहण अधिनियम 2013' : 'RFCTLARR Act 2013 Framework'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl overflow-hidden relative text-white">
              ...
              <div className="bg-[#002244]/80 px-4 py-3 text-white flex items-center justify-between border-b border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs font-semibold tracking-wider uppercase text-blue-100">
                    {isHi ? 'राष्ट्रीय भूमि अधिग्रहण ग्रिड - लाइव ट्रैकर' : 'National Land Acquisition Grid - Live'}
                  </span>
                </div>
              ...
              <div className="p-5 space-y-4 text-xs text-blue-50 bg-slate-900/30">
                ...
                <div className="p-3 rounded-lg bg-white/10 border border-white/15 flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-[11px] text-blue-200 mt-0.5">
                      {isHi ? 'अधिसूचना संख्या: LA-UP-2025-0842 • 84.6 हेक्टेयर' : 'Notification ID: LA-UP-2025-0842 • 84.6 Ha'}
                    </p>
                  </div>
                ...
                <div>
                  <div className="text-[11px] font-bold text-blue-200 uppercase tracking-wider mb-2 flex items-center justify-between">
                    <span>{isHi ? 'वैधानिक अधिग्रहण चरण' : 'Statutory Acquisition Pipeline'}</span>
                    <span className="text-emerald-300 font-semibold">{isHi ? 'चरण 4/5: पंचाट घोषणा' : 'Stage 4/5: Award Stage'}</span>
                  </div>
                ...
                <div className="p-3 rounded-lg bg-white/10 border border-white/15 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="font-semibold text-white flex items-center gap-1.5">
                      ...
                      {isHi ? 'एआई जमाबंदी सत्यापन परिशुद्धता' : 'AI Record Digitization Accuracy'}
                    </span>
                  ...
                  <div className="flex justify-between text-[10px] text-blue-200/80 pt-0.5">
                    <span>{isHi ? '14 भारतीय भाषाओं में हस्तलिखित ओसीआर' : 'Multilingual handwritten OCR'}</span>
                ...
                <div className="p-3 rounded-lg bg-white/10 border border-white/15">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-blue-100 font-medium">
                      {isHi ? 'पीएफएमएस प्रत्यक्ष लाभ अंतरण (DBT)' : 'PFMS Direct Benefit Transfer'}
                    </span>
                  ...
                  <div className="flex items-center gap-2 mt-1.5 text-[11px] text-emerald-300 font-medium">
                    ...
                    <span>{isHi ? '100% आधार से जुड़े बैंक खातों में सीधा भुगतान' : '100% Aadhaar-seeded accounts verified'}</span>
                  </div>
                </div>
                ...
                >
                  ...
                  <span>{isHi ? 'लाइव केस LA-UP-2025-0842 खोलें' : 'Inspect Sample Parcel LA-UP-2025-0842'}</span>
                </button>
              </div>
              ...
              <div className="bg-[#002244]/80 px-4 py-2 text-[10px] text-blue-200/80 border-t border-white/10 flex items-center justify-between">
                <span>{isHi ? 'डिजिटली हस्ताक्षरित एवं एनआईसी द्वारा प्रमाणित' : 'Digitally Signed & Certified by NIC'}</span>
